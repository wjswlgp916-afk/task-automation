...
DOCUMENT_TYPES: Dict[str, DocumentType] = {
    ...
    "completion_report": DocumentType(
        key="completion_report",
        label="완료계",
        render_hwp=completion_writer.render_hwp,
        render_pdf=completion_writer.render_pdf,
        template_filename="completion_report_template.hwp",
        extra_fields=(
            ExtraField("contract_date", "계약년월일", "date", default="2026-09-01",
                       help="대학마다 바뀌는 계약 체결일 (보통 고정, 필요시 수정)"),
            ExtraField("commencement_date", "착수년월일", "date", default="2026-09-01",
                       help="보통 고정 (필요시 수정)"),
    ...
    "commencement": DocumentType(
        ...
        extra_fields=(
            ExtraField("contract_date", "계약년월일", "date", default="2026-09-01",
                       help="대학마다 바뀌는 계약 체결일 (보통 고정, 필요시 수정, 완료계와 공유)"),
            ExtraField("completion_deadline", "완료기한", "date", default="2027-01-31",
    ...
    "warranty_bond": DocumentType(
        key="warranty_bond",
        label="하자(보수)이행보증각서",
        render_hwp=warranty_bond_writer.render_hwp,
        render_pdf=warranty_bond_writer.render_pdf,
        template_filename="warranty_bond_template.hwp",
        extra_fields=(
            ExtraField("period_start", "자문 시작일", "date", default="2026-09-01",
                       help="보통 고정 (필요시 수정, 계약서와 공유)"),
            ExtraField("period_end", "자문 종료일", "date", default="2027-01-31",
